...
type sexp =
    Atom of Position.position vala * (string vala)
  | Cons of Position.position vala * (sexp vala) * (sexp vala)
  | Nil of Position.position vala
...
type sexp =
    Atom of Position.position novala * (string novala)
  | Cons of Position.position novala * (sexp novala) * (sexp novala)
  | Nil of Position.position novala
end
